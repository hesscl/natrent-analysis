...
ggplot(tract_mdata, aes(x = lambda, fill = platform, color = platform)) +
  ...
  ggsave(filename = "./output/no_filter/desc/observed.pdf",
...
ggplot(tract_mdata, aes(x = lambda, fill = platform, color = platform)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  ggsave(filename = "./output/no_filter/desc/observed_weighted.pdf",
         width = 6, height = 4, dpi = 300)
...
ggplot(tract_mdata, aes(x = log(lambda), fill = platform, color = platform)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  ggsave(filename = "./output/no_filter/desc/log(lambda).pdf",
         width = 6, height = 4, dpi = 300)
...
ggplot(tract_mdata, aes(x = log(lambda), fill = platform, color = platform)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  ggsave(filename = "./output/no_filter/desc/log(lambda)_weighted.pdf",
         width = 6, height = 4, dpi = 300)
...
ggplot(tract_mdata, aes(x = log(lambda), fill = platform, color = platform)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  ggsave(filename = "./output/no_filter/desc/log(lambda)_by_city_sub.pdf",
         width = 6, height = 4, dpi = 300)
...
ggplot(tract_mdata, aes(x = log(lambda), fill = platform, color = platform)) +
  ...
  theme_minimal() +
  theme(legend.position = "bottom") +
  ggsave(filename = "./output/no_filter/desc/log(lambda)_weighted_by_city_sub.pdf",
         width = 6, height = 4, dpi = 300)
...
ggplot(city_sub_rep, aes(x = platform, y = shr, fill = city_sub)) +
  ...
  labs(x = "", y = "Share of all listings\n", 
       fill = "Location") +
  ggsave(filename = "./output/no_filter/desc/city_sub_rep.pdf",
         width = 6, height = 4, dpi = 300)
...
ggplot(diff_in_means_overall, 
  ...
  ggsave(filename = "./output/no_filter/desc/overall_diff_in_means.pdf",
...
ggplot(diff_in_means_city_sub, 
  ...
  labs(x = "\nCohen's d estimate", y = "", 
       color = "Platform", shape = "Platform") +
  ggsave(filename = "./output/no_filter/desc/city_sub_diff_in_means.pdf",
         width = 8, height = 6, dpi = 300)
...
stargazer(rep_lm_lambda_cl, rep_lm_lambda_apts, 
          ...
          out = "./output/no_filter/model/replication_models.tex")
...
stargazer::stargazer(gam_lambda_cl_1, gam_lambda_apts_1,
                    ...
                    #                      "Latino-White Segregation $\\times$ \\% Latino"),
                     ...
                     out = "./output/no_filter/model/gam.tex")
...
#                     labels = c("1952 (10th Ptile)", "1974 (50th Ptile)", "1996 (90th Ptile)")) +
 ## scale_fill_brewer(palette = "Set1", 
  ...
  ggsave(filename = "./output/no_filter/model/vac_rate_smoothed_effect.pdf",
         width = 8, height = 6, dpi = 300)
...
ggplot(gam_plot_shr_blk, aes(x = trt_shr_blk*100, y = visregFit, 
  ...
  ggsave(filename = "./output/no_filter/model/shr_black_interaction_effect.pdf",
         width = 8, height = 6, dpi = 300)
...
ggplot(gam_plot_shr_lat, aes(x = trt_shr_lat*100, y = visregFit, 
  ...
  ggsave(filename = "./output/no_filter/model/shr_latino_interaction_effect.pdf",
         width = 8, height = 6, dpi = 300)
